...
const specs = [
  {
    ...
    features: [
      ...
      ["Dwarven Strength", [2], "+2 Strength.", [["2", "ability", "str", "untyped"]]],
  ...
  },
  {
    ...
    features: [
      ["High Elf Agility", [1, 2], "+1 Agility at each listed racial level.", [["1", "ability", "dex", "untyped"]]],
  ...
  },
  {
    ...
    features: [
      ...
      ["Night Elf Agility", [3], "+2 Agility.", [["2", "ability", "dex", "untyped"]]],
  ...
  },
  {
    ...
    features: [
      ["Tauren Strength", [1, 3], "+1 Strength at each listed racial level.", [["1", "ability", "str", "untyped"]]],
      ["Tauren Charge", [1], "Charge using horns for horn damage plus 1-1/2 Strength modifier."],
      ["Tauren Spirit", [2], "+2 Spirit.", [["2", "ability", "wis", "untyped"]]],
  ...
  },
  {
    ...
    features: [
      ["Jungle Troll Stamina", [1, 3], "+1 Stamina at each listed racial level.", [["1", "ability", "con", "untyped"]]],
      ["Improved Rapid Healing", [1], "Recover hit points equal to Stamina modifier each hour; replaces Rapid Healing."],
      ["Jungle Troll Agility", [2], "+1 Agility.", [["1", "ability", "dex", "untyped"]]],
  ...
  },
  {
    ...
    features: [
      ["Forsaken Racial Advancement", [1, 2, 3], "+1 natural armor and +1 Strength at each racial level.", [["1", "ac", "nac", "untyped"], ["1", "ability", "str", "untyped"]]],
