export class EntrySelector extends FormApplication {
  constructor(...args) {
    super(...args);
    this.entries = foundry.utils.duplicate(foundry.utils.getProperty(this.object, this.attribute) || []);
  }
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      id: "entry-selector",
      classes: ["D35E", "entry"],
      template: "systems/warcraftrpg2e/templates/apps/entry-selector.html",
      width: 320,
      height: "auto",
      closeOnSubmit: false,
      submitOnClose: false,
