...
export class FeatSheet35E extends ItemSheetPF {
    ...
    activateListeners(html) {
        ...
        root.querySelectorAll("button[name='add-domain-spells']").forEach(el => el.addEventListener("click", this.#addSpellsToSpellbook.bind(this)));
        root.querySelectorAll('div[data-tab="description"] .item-add').forEach(el => el.addEventListener("click", this._addSpellListSpellToSpellbook.bind(this)));
    }
