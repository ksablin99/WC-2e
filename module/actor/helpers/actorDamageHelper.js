...
export class ActorDamageHelper {
    ...
    static async applyDamage(
        ...
        for (let t of tokensList) {
            ...
            if (simpleDamage) {
                ...
                let finalAc = {};
                if (fubmle) return;
                if (ev && (ev.shiftKey || (ev.originalEvent instanceof MouseEvent && ev.originalEvent.shiftKey))) {
                ...
                if (
                    ...
                    concealRolled = true;
                    concealRoll = (await new Roll35e("1d100").roll()).total;
                ...
                if (hit && a.system.attributes.fortification?.total) {
                    ...
                    fortifyRoll = (await new Roll35e("1d100").roll()).total;
                ...
                if (game.settings.get("warcraftrpg2e", "useAutoAmmoRecovery")) {
                    if (ammoId && attackerId && !hit) {
                        let recoveryRoll = (await new Roll35e("1d100").roll()).total;
                        if (recoveryRoll < 50) {
                            ammoRecovered = true;
                ...
                let chatTemplateData = {
                    ...
                    sourceImg: _attacker?.img || "systems/warcraftrpg2e/icons/special-abilities/imported.png",
                ...
                await createCustomChatMessage("systems/warcraftrpg2e/templates/chat/damage-description.html", templateData, chatData);
            }
            ...
            if (hit) {
                ...
                promises.push(
                    t.actor.update({
                        ...
                        "system.attributes.hp.value": Math.clamp(hp.value - (value - dt), -100, hp.max),
                    })
                );
            }
        }
    ...
    static getDRForActor(actor, base = false) {
        let damageTypes = foundry.utils.duplicate(this.getDRDamageTypes());
    ...
    static getERForActor(actor, base = false) {
        let damageTypes = foundry.utils.duplicate(this.getERDamageTypes());
        let actorData = actor.system;
            ...
            if (d.damageTypeUid) {
                ...
                if (_damage.system.damageType === "energy") {
                    ...
                    if (erValue?.immunity) {
                        ...
                        damageAfterEr = Math.floor(damageAfterEr * 1.5)
