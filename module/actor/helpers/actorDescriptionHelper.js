export class ActorDescriptionHelper {
    ...
    describeAlignment() {
        return this.actor.system.details.alignmentLabel ?? this.actor.system.details.alignment ?? "";
    }
    ...
    describeAC() {
        ...
        let sourceDetails =  foundry.utils.expandObject(this.actor.sourceDetails)
