...
export class ActorChangesHelper {
    ...
    static getChangeFlat(changeTarget, changeType, curData) {
        ...
        switch (changeTarget) {
            ...
            case "babattack":
                if (changeType === "base-replace") return "system.attributes.bab.basereplace";
            ...
            case "allSpeeds":
                if (changeType === "replace" || changeType === "base-replace") return null;
