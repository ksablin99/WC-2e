export class CurrencyConfig extends FormApplication {
  ...
  constructor(object, options) {
    ...
    let settings = game.settings.get("warcraftrpg2e", "currencyConfig")
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      id: 'currency-config',
      classes: ["D35E", "entry"],
      template: "systems/warcraftrpg2e/templates/settings/currency.html",
      width: 480,
      height: "auto",
    })
  }
  ...
  async _updateObject(event, formData) {
    ...
    await game.settings.set("warcraftrpg2e", "currencyConfig", settings)
